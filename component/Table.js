...
export default function BasicTable() {
  ...
  async function getData() {
    await fetch('http://3.35.175.207:3001/home/ubuntu/OTP_WEB/OTP_WEB/api/userList')
  ...
  async function handleActive(index) {
    ...
    const response = await axios.post('http://3.35.175.207:3001/home/ubuntu/OTP_WEB/OTP_WEB/api/active', {
