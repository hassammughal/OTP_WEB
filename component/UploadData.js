...
const CreateUserForm = (props) => {
    ...
    const AddingFiles = async (props) => {
        if(formats.includes(file.name.split('.').pop())){
            ...
            const response = await axios.post('http://3.35.175.207:3001/home/ubuntu/OTP_WEB/OTP_WEB/api/content', {
                filename: file.name,
        ...
        useEffect(() => {
        fetch('http://3.35.175.207:3001/home/ubuntu/OTP_WEB/OTP_WEB/api/teachers')
    ...
    useEffect(() => {
        fetch('http://3.35.175.207:3001/home/ubuntu/OTP_WEB/OTP_WEB/api/userList')
            .then((response) => response.json())
            .then((data) => setValue1(data))
    }, []);

    useEffect(() => {
        fetch('http://3.35.175.207:3001/home/ubuntu/OTP_WEB/OTP_WEB/api/levels')
            .then((response) => response.json())
